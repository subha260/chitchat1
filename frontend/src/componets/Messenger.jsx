...
import notificationSound from '../audio/Work Notification - Task Notification.mp3';
                    ...
                    <div className="friends">
                        {
                            ...
                            ((fd,index)=><div key={index} onClick={()=>setCurrentFriend(fd.fndInfo)} className={currentfriend._id === fd.fndInfo._id ? 'hover-friend active':'hover-friend'}>
