        ...
        <div className="friend">
            ...
            <div className="friend-name-seen">
                <div className="friend-name">
                    <h4 className={msgInfo?.senderId !== myId && msgInfo?.status !== undefined && msgInfo?.status !== 'seen Fd_name'?'unseen_message Fd_name':'Fd_name' }>{fndInfo.userName}</h4>
                ...
                </div>
                {
                    ...
                    <div className="seen-unseen-icon">
                        {
                            msgInfo.status === 'seen'?<img src={fndInfo.image} alt="" />:msgInfo.status === 'delivered'?<div className="delivered"><RiCheckboxCircleFill/></div>:<div className="unseen"><HiOutlineCheckCircle/></div>
                        }
                    </div>:
                    <div className="seen-unseen-icon">
                        {
